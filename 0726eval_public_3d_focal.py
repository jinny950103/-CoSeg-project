...
# 🌟 核心修改：精準對齊 Focal Loss 訓練產出的專屬權重檔
MODEL_WEIGHTS_PATH = os.path.join(PROJECT_ROOT, "outputs/coseg_public_mandibular_canal_focal_best.pth")
    ...
    with torch.no_grad(), torch.autocast(device_type="cuda", dtype=torch.bfloat16):
        for patient_id in patients:
            ...
            for img_f in tqdm(img_files, desc=f"評估 {patient_id}"):
                ...
                if (gt_mask > 0).any():
                    debug_dir = os.path.join(PROJECT_ROOT, "0726_2_compare")
